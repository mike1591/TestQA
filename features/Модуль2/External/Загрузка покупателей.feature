...
@Описание:  Подготовка данных покупатели
@ПримерИспользования: И проверяю или загружаю покупателей
Сценарий: проверяю или загружаю покупателей
